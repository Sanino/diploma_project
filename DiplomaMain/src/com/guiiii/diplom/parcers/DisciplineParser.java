	...
	private void parseLoad(Row row) {
		try{
			...
			if(type.equals("Ä")) {
				...
				if(lection.equals("ÇÎ")){
					lectionType = Lection.ZO;
				} else if (lection.equals("ÏÑ")) {
					lectionType = Lection.PS;
				} else if (lection.equals("ÔÄ")){
					lectionType = Lection.PS;
				} else if (lection.equals("ÏÂ")){
					lectionType = Lection.PV;
				} else if (lection.equals("ÑÏ")){
					lectionType = Lection.SP;
				} else if (lection.equals("ÌÏ")){
				...
				if(curse.equals("1 êóðñ")){
					curse1 = Curse.FIRST;
				} else if (curse.equals("2 êóðñ")){
					curse1 = Curse.SECOND;
				} else if (curse.equals("3 êóðñ")){
					curse1 = Curse.THIRD;
				} else if (curse.equals("4 êóðñ")){
					curse1 = Curse.FOURTH;
				} else if (curse.equals("Ñïåö")){
					curse1 = Curse.SPECIALIST;
				} else if (curse.equals("Ìàãèñòð")){
				...
				if(studyForm.equals("äíåâàÿ")){
					studyFormOcc = StudingForm.DAILY;
				} else if (studyForm.equals("çàî÷íàÿ")){
